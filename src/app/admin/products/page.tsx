      ...
      <div className="border-b border-gray-100 px-8 py-8">
        <div className="mx-auto flex max-w-7xl items-end justify-between">
          ...
          <Button
            ...
            className="flex items-center gap-2 bg-black px-6 py-3 text-xs tracking-[0.15em] text-white uppercase transition-opacity hover:opacity-70"
          >
        ...
        {!products?.length ? (
          <div className="flex flex-col items-center justify-center py-32 text-center">
            ...
            <Button
              ...
              className="mt-6 text-xs tracking-[0.15em] uppercase underline underline-offset-4"
            >
